...
void setup() {
 ...
 OxCore::serialBegin(115200UL);
  ...
  // These could be done with arrays and made shorter,
  ...
  dutyCycleProperties_int1.state_and_config = (void *) getConfig();
  ...
  dutyCycleProperties_ext1.state_and_config = (void *) getConfig();
  ...
  dutyCycleProperties_ext2.state_and_config = (void *) getConfig();
  core.AddTask(&dutyCycleTask_ext2, &dutyCycleProperties_ext2);
  dutyCycleTask_ext1.whichHeater = Ext2;

  dutyCycleTask_int1.one_pin_heater = getConfig()->hal->_ac_heaters[0];
  dutyCycleTask_ext1.one_pin_heater = getConfig()->hal->_ac_heaters[1];
  dutyCycleTask_ext2.one_pin_heater = getConfig()->hal->_ac_heaters[2];
  ...
  HeaterPIDProperties_int1.state_and_config = (void *) getConfig();
  ...
  HeaterPIDProperties_ext1.state_and_config = (void *) getConfig();
  ...
  HeaterPIDProperties_ext2.state_and_config = (void *) getConfig();
  ...
  stage2HeaterProperties_int1.state_and_config = (void *) getConfig();
  ...
  stage2HeaterProperties_ext1.state_and_config = (void *) getConfig();
  ...
  stage2HeaterProperties_ext2.state_and_config = (void *) getConfig();
  ...
  stage2HeaterTask_int1.STAGE2_TARGET_TEMP = getConfig()->TARGET_TEMP;
  stage2HeaterTask_ext1.STAGE2_TARGET_TEMP = getConfig()->TARGET_TEMP;
  stage2HeaterTask_ext2.STAGE2_TARGET_TEMP = getConfig()->TARGET_TEMP;

  stage2HeaterTask_int1.STAGE2_OPERATING_TEMP = getConfig()->STAGE2_OPERATING_TEMP[Int1];
  stage2HeaterTask_ext1.STAGE2_OPERATING_TEMP = getConfig()->STAGE2_OPERATING_TEMP[Ext1];
  stage2HeaterTask_ext2.STAGE2_OPERATING_TEMP = getConfig()->STAGE2_OPERATING_TEMP[Ext2];
